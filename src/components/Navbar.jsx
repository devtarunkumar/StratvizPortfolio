...
import logo from "../assets/portlogo.png"; // ✅ import your logo
                ...
                <div className="max-w-7xl mx-auto flex justify-between items-center px-6 md:px-12 py-4">
                    ...
                    <div className="relative flex items-center">
                        <img
                            src={logo}
                            alt="logo"
                            className="absolute left-0 top-1/2 -translate-y-1/2 w-16 md:w-20 opacity-30"
                        />

                        <h1 className="text-xl md:text-2xl font-bold tracking-wide bg-gradient-to-r from-purple-500 to-pink-500 bg-clip-text text-transparent pl-16 md:pl-20">
                            StratvizSolutions
                        </h1>
                    </div>
